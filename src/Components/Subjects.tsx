...
import Materia3 from '../assets/Materia3/foto 5 e capa.jpg';
import { Link } from 'react-router-dom';
import Subject from '../assets/subject.png';

export const Subjects = () => {
    // resolução no 1600px foto bugada.
    // link para pagina em branco
    return (
        <>
            <Header currentPage='MATERIAS'/>
                <div className='overflow-auto h-fit mt-44'>
                    <div className='mx-24 xl:mx-44'>
                        ...
                        <div className='grid grid-cols-3 gap-6 justify-items-center mt-10 mb-32'>
                            <Link className='' to={'/subjectcontentInterview'}>
                                <img src={Materia1} alt="Materia1" className="h-56 m-auto" />
                                <div className="grid justify-center mt-4">
                                    <p className='text-lg font-bold text-center' style={{color: '#292822', fontFamily: 'barlowBold', lineHeight: '24px'}}>
                            ...
                            {/* <div className=''>
                                ...
                                <div className="grid justify-center">
                                    ...
                                    <p className='text-lg text-center' style={{color: '#292822', fontFamily: 'barlowRegular'}}>Resumo</p>
                                </div>
                            </div>
                            <div className=''>
                                <img src={Subject} alt="Subject" className="w-auto h-56" />
