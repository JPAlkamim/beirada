    ...
    return (
        <>
            ...
            <div className='pt-48 mx-24 xl:mx-64 grid'>
                ...
                <a href="https://www.amistosos.com.br/cj/index.php" target="_blank" rel="noopener noreferrer">
                    <span
                        style={{ color: '#254E22', fontFamily: 'loraRegular', cursor: 'pointer', textDecoration: 'underline' }}
                    >
                ...
                <a href="https://www.amistosos.com.br/competicoes/" target="_blank" rel="noopener noreferrer">
                    <span
                        style={{ color: '#254E22', fontFamily: 'loraRegular', cursor: 'pointer', textDecoration: 'underline' }}
                    >
                ...
                <a href="https://www.instagram.com/bigbol.mga/?hl=pt-br" target="_blank" rel="noopener noreferrer">
                    <span
                        style={{ color: '#254E22', fontFamily: 'loraRegular', cursor: 'pointer', textDecoration: 'underline' }}
                    >
                        {'Bigbol Society'}
                ...
                &nbsp; e na &nbsp; 
                <a href="https://www.instagram.com/arenaatleticomaringaense/?hl=pt-br" target="_blank" rel="noopener noreferrer">
                    <span
                        style={{ color: '#254E22', fontFamily: 'loraRegular', cursor: 'pointer', textDecoration: 'underline' }}
                    >
                ...
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
                <b>Professor Preto:</b> A Liga Amistosos em geral, a Amistosos Eventos, surgiu em agosto de 2014, através de um bate-papo num café, onde as equipes começaram a me procurar para eu intermediar a marcação de jogos para eles, jogo amistoso no caso. E aí um amigo meu estava comigo junto e falou ‘está aí o que a gente precisa fazer’.
                </p>
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
                Aí eu criei um site, 
                <a href="http://amistosos.com.br" target="_blank" rel="noopener noreferrer">
                    <span
                        style={{ color: '#254E22', fontFamily: 'loraRegular', cursor: 'pointer', textDecoration: 'underline' }}
                    >
                        {'amistosos.com.br'}
                ...
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
                <b>Professor Preto:</b> Sim. Eu sou formado em Educação Física há 22 anos, sou professor de futebol, professor de futsal e muitos dos garotos que você vê aqui me cumprimentando foram meus atletas. 
                </p>
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
                ...
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
                <b>Professor Preto:</b> Hoje nós temos mais de 80 colaboradores participando – entre arbitragem, equipe de trabalho, staffs – além de uns dez locais fixos de atuação de eventos. No fut7, a Bigbol e o Atlético Maringaense são os dois pontos fixos. No futsal, nós temos clubes como AABB, ACEMA e Colégio Marista.
                </p>
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
                ...
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
                <b>Professor Preto:</b> Todos são prestadores de serviço. Dentro do fut7, hoje, eu tenho meu braço direito que é o meu diretor, o Henrique, que faz toda essa válvula do fut7 andar e acontecer, hoje com 96 equipes na nossa competição. Então o Henrique é o maior responsável, ele é meu sócio aqui no fut7. 
                </p>
                ...
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
                <b>Professor Preto:</b> Eles fazem parte. A minha esposa é o financeiro das empresas, então ela faz parte do convívio. O meu principal escritório é dentro da minha casa ainda. Então, meu filho está crescendo ali, me vendo trabalhar, eu consigo dar atenção para ele e para minha esposa.
                </p>
                <p className='text-lg my-4' style={{color: '#292822', fontFamily: 'loraRegular'}}>
