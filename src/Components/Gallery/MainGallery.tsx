        ...
        <div className='mt-48 mb-24 mx-24 xl:mx-44'>
            ...
            <div className="grid grid-cols-3 gap-6 justify-items-center">
                <div className='relative' onClick={handlePhotoDetail}>
                    <img src={photo} alt="logo" className="cursor-pointer w-screen transition duration-300 ease-in-out hover:shadow-lg dark:hover:shadow-black/30" style={{height: '500px', width: '400px'}} />
                    <p className='text-2xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'
                    style={{color: '#FFF', fontFamily: 'Barlow'}}>Fotos</p>
                </div>
                <div className='relative' onClick={() => setGaleryType('VIDEOS')}>
                    <img src={image1} alt="logo" className="cursor-pointer w-screen transition duration-300 ease-in-out hover:shadow-lg dark:hover:shadow-black/30" style={{height: '500px', width: '400px'}} />
                    <p className='text-2xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'
                    style={{color: '#292822', fontFamily: 'Barlow'}}>Vídeos</p>
                </div>
                <div className='relative' onClick={() => setGaleryType('AUDIO')}>
                    <img src={audio} alt="logo" className="cursor-pointer w-screen transition duration-300 ease-in-out hover:shadow-lg dark:hover:shadow-black/30" style={{height: '500px', width: '400px'}} />
                    <p className='text-2xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'
                    style={{color: '#FFF', fontFamily: 'Barlow'}}>Áudios</p>
                </div>
            </div>
        </div>
    </>
